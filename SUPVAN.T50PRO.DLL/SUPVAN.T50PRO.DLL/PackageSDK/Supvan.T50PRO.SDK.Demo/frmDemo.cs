...
namespace Supvan.T50PRO.SDK.Demo
{
    ...
    public partial class frmDemo : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            //打印设置
            sDKTPParamter.PrintSet = new SDKPrintSet() { Copy = 1,  Deepness = 4, DPI = 8f,  Direction=0, Gap=3, Speed=40, Width=50, Height=30, PaperType=1, MaxDotValue = 384, OffsetH = 0, OffsetV = 0, OneByOne = true };
            //打印文件
